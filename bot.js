...
client.on('message', message => {
    ...
    if(!message.channel.guild) return message.channel.send('**This Command Only For Servers !**')
            if (!message.member.hasPermission('MANAGE_ROLES')) return message.channel.send(`**${message.author.username} You Dont Have** ``MANAGE_ROLES`` **Premission**`);
                     ...
                     message.guild.createRole({ name: "·)»one", color: "#ffffff", permissions: [] })
                     message.guild.createRole({ name: "·)»two", color: "#ffffff", permissions: [] })
                     message.guild.createRole({ name: "·)»president", color: "#ffffff", permissions: [] })
                     message.guild.createRole({ name: "·)»visa president", color: "#ffffff", permissions: [] })
                     ...
                     message.guild.createRole({ name: "·)» Brother", color: "#ffffff", permissions: [] })
                     message.guild.createRole({ name: "·)» Diamond", color: "#ffffff", permissions: [] })
                     message.guild.createRole({ name: "·)» Bronze", color: "#ffffff", permissions: [] })
                     message.guild.createRole({ name: "·)» Silver", color: "#ffffff", permissions: [] })
					 message.guild.createRole({ name: "·)» Golden", color: "#ffffff", permissions: [] })
	                 message.guild.createRole({ name: "·)» Client", color: "#ffffff", permissions: [] })
                     message.guild.createRole({ name: "·)» Donator", color: "#ffffff", permissions: [] })
